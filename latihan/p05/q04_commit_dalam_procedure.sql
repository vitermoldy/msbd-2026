-- Diminta: membuat salinan procedure yang menjalankan COMMIT setelah INSERT pertama, lalu mengujinya dari Python.
-- Dipilih: COMMIT diletakkan setelah INSERT rental_tx untuk membuktikan bahwa batas transaksi tidak boleh diambil alih procedure.
-- Alternatif: tanpa COMMIT seperti procedure sebelumnya; tidak dipilih karena soal meminta pengujian COMMIT di dalam procedure.
